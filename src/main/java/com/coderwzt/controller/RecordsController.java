...
import com.coderwzt.service.IRecordsService;
...
public class RecordsController {
   ...
   public JsonObject queryRecordsAll(@RequestParam(defaultValue = "1") Integer page,
    ...
    public JsonObject queryPropertyAll2(RecordVo recordVo, HttpServletRequest request,
        ...
        /*
           步骤：
             ...
             2、添加物业收费信息
                ...
                2.5 添加工作
         */
        this.recordsService.addRecords(records);
        return R.ok();
